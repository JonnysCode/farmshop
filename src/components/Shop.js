...
import logo from './images/papst.png';
import seeds from './images/seeds.jpg';
import protection from './images/protection.jpg';
import fertelizer from './images/fertelizer.jpg';
import p1 from './images/p1.jfif';
import p2 from './images/corn.jfif';
import p3 from './images/p3.jfif';
import p4 from './images/tomatos.jfif';
                              ...
                              <div className="relative flex">
                                <Popover.Button
                                  className={classNames(
                                    open ? 'text-lime-600' : 'text-gray-700 hover:text-gray-800',
          ...
          <div className="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
            ...
            <div className="relative py-32">
              ...
              <div className="mt-4 sm:mt-6">
                <a
                  href="#"
                  className="inline-block bg-lime-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-lime-700"
                >
              ...
              <div className="mt-12 md:mt-0 md:row-start-2 md:col-start-3 md:col-span-8 lg:row-start-1 lg:col-start-9 lg:col-span-4">
                ...
                <form className="mt-2 flex sm:max-w-md">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:border-lime-500 focus:ring-1 focus:ring-lime-500"
                  />
                  <div className="ml-4 flex-shrink-0">
                    <button
                      type="submit"
                      className="w-full bg-lime-600 border border-transparent rounded-md shadow-sm py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-500"
                    >
                      Sign up
                    </button>
                  </div>
