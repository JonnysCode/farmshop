...
export default function Farm() {
  return (
    ...
    <div className='h-screen'>
      ...
      <div className="grid grid-cols-4 h-5/6 ">
        <div className="col-span-3 h-full bg-white pb-3">
          <div className=' m-2 shadow overflow-hidden sm:rounded-md h-full '>
            <img
              src={satellite}
              alt=""
        ...
        <div className="col-span-4 h-60 bg-white p-2">
